...
from experiments.exp_fujiatian import Exp_fujiatian
...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='fujiatian', choices=['ETTh1', 'ETTh2', 'ETTm1','fujiatian'], help='name of dataset')
parser.add_argument('--root_path', type=str, default='./datasets/power_data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='fujiatian.csv', help='location of the data file')
...
data_parser = {
    'fujiatian':{'data':'fujiatian.csv','T':'OT','M': [6, 6, 6], 'S': [1, 1, 1], 'MS': [6, 6, 1]},
