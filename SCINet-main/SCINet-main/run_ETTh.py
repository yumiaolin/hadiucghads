...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'ETTh2', 'ETTm1','IMF-1','FJT_S'], help='name of dataset')
...
parser.add_argument('--inverse', type=bool, default =True, help='将输出数据反归一化')
